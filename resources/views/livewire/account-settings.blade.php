<div class="container mt-4">
    ...
    <ul class="nav nav-pills mb-4 justify-content-center" id="settingsTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link @if($emailActive) active @endif" id="email-tab" data-bs-toggle="pill"
                data-bs-target="#email" type="button" role="tab">
                <i class="fas fa-user me-1"></i> Email
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link @if($passwordActive) active @endif" id="password-tab" data-bs-toggle="pill"
                data-bs-target="#password" type="button" role="tab">
                <i class="fas fa-lock me-1"></i> Password
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link @if($privacyActive) active @endif" id="privacy-tab" data-bs-toggle="pill"
                        ...
                        <form wire:submit="changePassword">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="password_confirmation"
                                    placeholder="••••••••" wire:model="password_confirmation" required>
                            </div>
                            <button type="submit" class="btn greenbtn mt-0"><i class="fas fa-key me-1"></i> Update
                                Password</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="tab-pane fade @if($privacyActive) show active @endif" id="privacy" role="tabpanel">
                    ...
                    <div class="box p-3">
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" role="switch" id="hideName"
                                wire:model.live="ToggleHideName" @if ($ToggleHideName) checked @endif>
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="hideLocation"
                                wire:model.live="ToggleHideLocation" @if ($ToggleHideLocation) checked @endif>
                            <label class="form-check-label" for="hideLocation">Hide Location
                                <small class="text-muted d-block">Your location won't be shown across the
                                    website</small>
                            </label>
                        </div>
                    </div>
