            ...
            <div class="col-lg-8 mt-2">
                <div class="box p-1">
                    ...
                    <section class="hero-completedbefore">
                        ...
                        <h4>Hi there! 👋</h4>
                        <p>We'd love for you to join our community. Please <a href="/login" style="color: #fff;">log
                                in</a> or <a href="/register" style="color: #fff;">sign up</a> to donate meals and make
                            a real impact.</p>
                    ...
                    <section class="hero-error">
                        ...
                        <section class="hero-error">
                            ...
                            <section class="hero-completedbefore">
                                ...
                                <p class="lead bottomtext">Your donation has already been received, thank you so much!
                                </p>
                                @elseif (session('pending'))
                                <section class="hero-completedbefore">
                                    <h1 class="display-4 toptext">Payment Pending</h1>
                                    <p class="lead bottomtext">Your donation is currently travelling through the PayPal
                                        world, it should be processed within 24 hours!</p>
                                    @elseif (session('success'))
                                    <section class="hero-success">
                                        <h1 class="display-4 toptext">Payment Successful</h1>
                                        <p class="lead bottomtext">Your donation has been received, thank you so much!
                                        </p>
                                        @else
                                        <section class="hero">
                                            <h1 class="display-4 toptext">Support Our Mission</h1>
                                            <p class="lead bottomtext">Your donation helps us to continue making a
                                                difference.</p>
                                            @endif
                                        </section>
                                            ...
                                            <form wire:submit.prevent="createOrder">
                                                ...
                                                <div class="mb-3 input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="donationAmount"
                                                        placeholder="Amount" min="1" max="100" step="1" value="1"
                                                ...
                                                <div class="row mb-1 justify-content-center">
                                                    <div class="col-5 col-md-2">
                                                        <div class="box p-1">
                                                            <div class="boxinner p-1">
                                                                <p class="fw-bold fs-4 text-center mb-0">{{ $quantity }}
                                                                </p>
                                                    ...
                                                    <div class="col-5 col-md-2">
                                                        <div class="box p-1">
                                                            <div class="boxinner p-1">
                                                                <p class="fw-bold fs-4 text-center mt-0 mb-0">&pound;{{
                                                                    number_format($viewtotal, 2) }}</p>
                                                ...
                                                <button type="submit" class="btn greenbtn mt-0"><i
                                                        class="fa-brands fa-paypal me-2"></i> Donate via PayPal</button>
                                            </form>
                                        </div>
                                        @endguest
                </div>
