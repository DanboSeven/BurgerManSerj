...
@endif
    ...
    <div class="boxinner mb-1">
        <strong><i class="fa-solid fa-user me-1"></i> {{ $loggedInUser->first_name }}</strong>, you are currently ranked <span class="badge leaderboard-rank">#{{ $userRank }}</span> on the leaderboard with 
    ...
    @auth
    <li class="list-group-item d-flex justify-content-between align-items-center {{ $user->id === $loggedInUser->id ? 'myleaderboard' : '' }}">
    @else
    ...
    @endauth
            ...
            <span class="badge leaderboard-rank"><i class="fa-solid fa-burger me-1"></i> {{ $user->meals_donated }} Meals</span>
        </li>
    @empty
